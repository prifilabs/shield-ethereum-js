        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        bits = _a.sent();
                        return [2 /*return*/, (0, utils_1.getRolesFromBytes)(bits, roles).map(ethers_1.utils.parseBytes32String)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        newRoles = (0, utils_1.getBytesFromRoles)(roles.map(ethers_1.utils.formatBytes32String), existingRoles);
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, policy.map(function (bits) {
                                return (0, utils_1.getRolesFromBytes)(bits, roles).map(ethers_1.utils.parseBytes32String);
                            })];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        newPolicy = policy.map(function (step) {
                            return (0, utils_1.getBytesFromRoles)(step.map(ethers_1.utils.formatBytes32String), roles);
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signer = _a.sent();
                        return [2 /*return*/, this.contract.validateCredentials(credentials, credentials.signer, credentials.to, credentials.call.slice(0, 10), credentials.call, full)];
                }
            });
        });
    };
