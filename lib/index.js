...
function createShieldInstance(signer, address, iface) {
    return __awaiter(this, void 0, void 0, function () {
        var contract;
        return __generator(this, function (_a) {
            contract = new ethers_1.Contract(address, iface, signer);
...
var Shield = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, createCredentials(signer, this.contract, "setUser", [address, newRoles])];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        existingRoles = _a.sent();
                        newRoles = getBytesFromRoles(roles.map(ethers_1.utils.formatBytes32String), existingRoles);
                        return [2 /*return*/, this.contract.connect(signer).setUser(address, newRoles, credentials)];
                }
            });
        });
    };
    Shield.prototype.getPolicys = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        roles = _a.sent();
                        return [4 /*yield*/, this.contract.getPolicy(ethers_1.utils.formatBytes32String(label))];
                    case 2:
                        policy = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, createCredentials(signer, this.contract, "addPolicy", [newLabel, newPolicy])];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.contract.connect(signer).addPolicy(newLabel, newPolicy, credentials)];
                }
            });
        });
    };
    ...
    Shield.prototype.createCredentialsForAssignPolicy = function (signer, to, f, label) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                sig = to.interface.getSighash(f);
                newLabel = ethers_1.utils.formatBytes32String(label);
                return [2 /*return*/, createCredentials(signer, this.contract, "assignPolicy", [to.address, sig, newLabel])];
            });
        });
    };
    Shield.prototype.assignPolicy = function (signer, to, f, label, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                sig = to.interface.getSighash(f);
                newLabel = ethers_1.utils.formatBytes32String(label);
                return [2 /*return*/, this.contract.connect(signer).assignPolicy(to.address, sig, newLabel, credentials)];
            });
        });
    };
    ...
    Shield.prototype.validateCredentials = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var signer, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signer = _a.sent();
                        return [4 /*yield*/, this.contract.validateCredentials(credentials, credentials.signer, credentials.to, credentials.call.slice(0, 10), credentials.call)];
                    case 2:
                        _a.sent();
