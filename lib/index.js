...
function encodeCredentials(credentials) {
    ...
    return window.btoa(JSON.stringify({ to: to, call: call, timestamp: timestamp, approvals: approvals.map(btoa) }));
}
exports.encodeCredentials = encodeCredentials;
function decodeCredentials(encodedCredentials) {
    var _a = JSON.parse(window.atob(encodedCredentials)), to = _a.to, call = _a.call, timestamp = _a.timestamp, approvals = _a.approvals;
