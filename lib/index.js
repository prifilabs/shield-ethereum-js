...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.createCredentialsForPause = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, createCredentials(this.signer, this.contract, "pause", [])];
            });
        });
    };
    Shield.prototype.pause = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contract.pause(credentials)];
            });
        });
    };
    Shield.prototype.createCredentialsForUnpause = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, createCredentials(this.signer, this.contract, "unpause", [])];
            });
        });
    };
    Shield.prototype.unpause = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contract.unpause(credentials)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.contract.validateCredentials(credentials)];
                    case 1:
                        _a.sent();
