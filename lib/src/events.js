...
exports.getPolicyAssigned = exports.getPolicyAdded = exports.getUsersSet = exports.getRolesAdded = exports.getShieldableAdded = exports.getShieldCreated = void 0;
...
function getShieldableAdded(shield, first, last) {
    return __awaiter(this, void 0, void 0, function () {
        var events, shieldables, _i, events_2, event_2, shieldable;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, shield.queryFilter('ShieldableAdded', first, last)];
                case 1:
                    events = _a.sent();
                    shieldables = [];
                    for (_i = 0, events_2 = events; _i < events_2.length; _i++) {
                        event_2 = events_2[_i];
                        shieldable = event_2.args[0];
                        shieldables.push(shieldable);
                    }
                    return [2 /*return*/, shieldables];
            }
        });
    });
}
exports.getShieldableAdded = getShieldableAdded;
function getRolesAdded(shield, first, last) {
    return __awaiter(this, void 0, void 0, function () {
        var events, roles, _i, events_3, event_3, l;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
function getUsersSet(shield, first, last, roles) {
    return __awaiter(this, void 0, void 0, function () {
        var events, users, _i, events_4, event_4, _users, _a, _users_1, user, addr, bits;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
function getPolicyAdded(shield, first, last, roles) {
    return __awaiter(this, void 0, void 0, function () {
        var events, policies, _i, events_5, event_5, _a, label, policy, decodedLabel, decodedPolicy;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, events_5 = events; _i < events_5.length; _i++) {
                        event_5 = events_5[_i];
                        _a = event_5.args, label = _a[0], policy = _a[1];
...
function getPolicyAssigned(shield, first, last) {
    return __awaiter(this, void 0, void 0, function () {
        var events, assignments, _i, events_6, event_6, _a, to, sig, label, decodedLabel;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    events = _b.sent();
                    assignments = {};
                    for (_i = 0, events_6 = events; _i < events_6.length; _i++) {
                        event_6 = events_6[_i];
                        _a = event_6.args, to = _a[0], sig = _a[1], label = _a[2];
