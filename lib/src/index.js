        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    call = to.interface.encodeFunctionData(func, __spreadArray(__spreadArray([], args, true), [
                        nullCredential,
                    ], false));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { to: credentials.to, func: func, args: args, timestamp: credentials.timestamp, approvals: signers }];
                }
            });
        });
    };
