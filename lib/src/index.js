...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.addShieldable = function (address, iface) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.store.addShieldable(address, iface)];
            });
        });
    };
    Shield.prototype.getShieldables = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.store.getShieldables()];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (address == this.contract.address) {
                    return [2 /*return*/, SHIELD_INTERFACE];
                }
    ...
    Shield.prototype.checkCredentials = function (credentials, full) {
        return __awaiter(this, void 0, void 0, function () {
            var signers, iface, _a, func, args;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        full = typeof full === 'undefined' ? false : full;
                        return [4 /*yield*/, this.contract.validateCredentials(credentials, full)];
                    case 1:
                        signers = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        approvals = (_c.sent()).approvals;
                        _b = (_a = approvals).indexOf;
                        return [4 /*yield*/, this.signer.getAddress()];
                    case 2:
                        if (_b.apply(_a, [_c.sent()]) == -1) {
                            throw new Error("signer is not one of the approvers");
                        }
                        return [4 /*yield*/, this.contract.connect(this.signer).executeCredentials(credentials, options)];
                    case 3:
                        tx = _c.sent();
