...
exports.Shield = exports.instantiateShield = exports.createShield = exports.getShields = exports.getDefaultFactory = exports.utils = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, shield.initStorage()];
                case 1:
                    _a.sent();
...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.initStorage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var network;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (network in config_json_1.default) {
                            this.store = new Store.ServerStore(network, this.contract.address);
                        }
                        else {
    ...
    Shield.prototype.createCredentialsForAddRoles = function (roles) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.createCredentials(this.contract.address, 'addRoles', [newRoles])];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.createCredentials(this.contract.address, 'setUsers', [newUsers])];
                }
            });
        });
    };
    ...
    Shield.prototype.createCredentialsForAssignPolicy = function (to, func, label) {
        return __awaiter(this, void 0, void 0, function () {
            var iface, sig, newLabel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getInterface(to)];
                    case 1:
                        iface = _a.sent();
                        sig = utils.getSignature(func, iface);
                        newLabel = ethers_1.ethers.utils.formatBytes32String(label);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        signature = _a.sent();
                        credentials = { timestamp: timestamp, chainid: chainid, to: to, call: call, approvals: [signature] };
    ...
    Shield.prototype.executeCredentials = function (credentials, options) {
        return __awaiter(this, void 0, void 0, function () {
            var approvals, _a, _b, iface, contract, _c, func, args;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, contract[func].apply(this, __spreadArray(__spreadArray([], args, true), [credentials], false), options)];
                }
            });
        });
    };
