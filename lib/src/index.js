        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, shields[address]];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    shields = _a.sent();
                    return [2 /*return*/, Object.keys(shields).filter(function (shield) {
                            return __awaiter(this, void 0, void 0, function () {
                                var contract, roles, users;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            contract = new ethers_1.ethers.Contract(shield, SHIELD_INTERFACE, signer);
                                            return [4 /*yield*/, contract.getRoles()];
                                        case 1:
                                            roles = _a.sent();
                                            return [4 /*yield*/, (0, events_1.getUserSet)(contract, 0, 'latest', roles)];
                                        case 2:
                                            users = _a.sent();
                                            return [4 /*yield*/, signer.getAddress()];
                                        case 3: return [2 /*return*/, ((_a.sent()) in users)];
                                    }
                                });
                            });
                        })];
...
var Shield = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        roles = _a.sent();
                        return [2 /*return*/, (0, events_1.getUserSet)(this.contract, 0, 'latest', roles)];
                }
            });
        });
    };
    ...
    Shield.prototype.createCredentialsForSetUsers = function (signer, users) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, users_1 = users; _i < users_1.length; _i++) {
                            user = users_1[_i];
                            newRoles = (0, utils_1.getBytesFromRoles)(user.roles.map(ethers_1.ethers.utils.formatBytes32String), existingRoles);
                            newUsers.push({ addr: user.address, roles: newRoles });
                        }
                        return [2 /*return*/, createCredentials(signer, this.contract, 'setUsers', [
                                newUsers
                            ])];
                }
            });
    ...
    Shield.prototype.getAssignedPolicies = function () {
        return __awaiter(this, void 0, void 0, function () {
            var addresses, assignments, address, sig, f;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (address in addresses) {
                            assignments[address] = {};
                            for (sig in addresses[address]) {
                                f = address in this.abis
    ...
    Shield.prototype.isBurnt = function (signer, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var contract;
            return __generator(this, function (_a) {
                contract = new ethers_1.ethers.Contract(credentials.to, this.abis[credentials.to], signer);
                return [2 /*return*/, contract.burns(ethers_1.ethers.utils.keccak256(credentials.approvals[0]))];
            });
        });
    };
    return Shield;
