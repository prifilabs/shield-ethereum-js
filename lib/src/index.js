        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, instantiateShield(signer, address)];
            }
        });
    });
}
...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.addAbi = function (address, iface) {
    ...
    Shield.prototype.getAssignedPolicy = function (to, fragment) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        roles = _a.sent();
                        sig = to.interface.getSighash(fragment);
    ...
    Shield.prototype.createCredentialsForAssignPolicy = function (signer, to, fragment, label) {
        return __awaiter(this, void 0, void 0, function () {
            var sig, newLabel;
            return __generator(this, function (_a) {
                sig = to.interface.getSighash(fragment);
    ...
    Shield.prototype.assignPolicy = function (signer, to, fragment, label, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            var sig, newLabel;
            return __generator(this, function (_a) {
                sig = to.interface.getSighash(fragment);
    ...
    Shield.prototype.checkCredentials = function (credentials, full) {
        return __awaiter(this, void 0, void 0, function () {
            var signer, signers, fragment, args;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        signer = _a.sent();
                        signers = this.contract.validateCredentials(credentials, signer, credentials.to, credentials.call.slice(0, 10), credentials.call, full);
                        if (credentials.to in this.abis) {
                            fragment = this.abis[credentials.to].getFunction(fragment).name;
                            args = (0, utils_1.extractArguments)(this.abis[credentials.to], fragment, args);
                        }
                        else {
                            fragment = credentials.call.slice(0, 10);
                            args = [credentials.call.slice(10)];
                        }
                        return [2 /*return*/, { to: credentials.to, fragment: fragment, args: args, timestamp: credentials.timestamp, approvals: signers }];
                }
            });
        });
    };
