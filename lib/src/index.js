...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.checkCredentials = function (credentials, full) {
        return __awaiter(this, void 0, void 0, function () {
            var signer, sig, signers, func, args, nullCredentials;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        if (credentials.to in this.abis) {
                            ...
                            nullCredentials = ethers_1.ethers.utils.hexStripZeros(ethers_1.ethers.utils.defaultAbiCoder.encode(['tuple(address, uint, bytes, bytes[])'], [[ethers_1.ethers.constants.AddressZero, 0, ethers_1.ethers.constants.HashZero, []]]));
                            args = this.abis[credentials.to].decodeFunctionData(func, ethers_1.ethers.utils.hexConcat([credentials.call, nullCredentials]));
                            args = args.slice(0, -1);
                        }
                        else {
                            func = sig;
