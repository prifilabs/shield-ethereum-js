...
exports.Shield = exports.instantiateShield = exports.createShield = exports.getShields = exports.getShieldName = exports.decodeCredentials = exports.encodeCredentials = exports.approveCredentials = exports.createCredentials = exports.getDefaultFactory = void 0;
...
function getShieldName(address, factory) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, lock.acquire('getShieldName', function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var events, _i, events_1, event_1, _a, _, address_1, name_1;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    if (factory.address in cache) {
                                        if (address in cache[factory.address].data) {
                                            return [2 /*return*/, cache[factory.address].data[address]];
                                        }
                                    }
                                    else {
                                        cache[factory.address] = { lastblock: factory.deployTransaction.blockNumber, data: {} };
                                    }
                                    return [4 /*yield*/, factory.queryFilter('ShieldCreated', cache[factory.address].lastBlock + 1, "latest")];
                                case 1:
                                    events = _b.sent();
                                    for (_i = 0, events_1 = events; _i < events_1.length; _i++) {
                                        event_1 = events_1[_i];
                                        _a = event_1.args, _ = _a[0], address_1 = _a[1], name_1 = _a[2];
                                        cache[factory.address].data[address_1] = ethers_1.ethers.utils.parseBytes32String(name_1);
                                    }
                                    return [2 /*return*/, cache[factory.address].data[address]];
                            }
                        });
...
function getShields(address, factory) {
    return __awaiter(this, void 0, void 0, function () {
        var firstBlock, events, shields;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    firstBlock = factory.deployTransaction.blockNumber;
                    return [4 /*yield*/, factory.queryFilter('UserAdded', firstBlock, "latest")];
                case 1:
                    events = _a.sent();
                    shields = new Set();
...
var Shield = /** @class */ (function () {
    ...
    Shield.prototype.getUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var firstBlock, events, roles, users, _i, events_2, event_2, _a, user, bits;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contract.born()];
                    case 1:
                        firstBlock = (_b.sent()).toNumber();
                        return [4 /*yield*/, this.contract.queryFilter('UserSet', firstBlock, "latest")];
                    case 2:
                        events = _b.sent();
    ...
    Shield.prototype.getPolicies = function () {
        return __awaiter(this, void 0, void 0, function () {
            var firstBlock, events, roles, policies, _i, events_3, event_3, _a, label, policy, decodedLabel, decodedPolicy;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contract.born()];
                    case 1:
                        firstBlock = (_b.sent()).toNumber();
                        return [4 /*yield*/, this.contract.queryFilter('PolicyAdded', firstBlock, "latest")];
                    case 2:
                        events = _b.sent();
                        return [4 /*yield*/, this.contract.getRoles()];
                    case 3:
    ...
    Shield.prototype.getAssignedPolicies = function () {
        return __awaiter(this, void 0, void 0, function () {
            var firstBlock, events, assignments, _i, events_4, event_4, _a, to, sig, label, decodedLabel, f;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contract.born()];
                    case 1:
                        firstBlock = (_b.sent()).toNumber();
                        return [4 /*yield*/, this.contract.queryFilter('PolicyAssigned', firstBlock, "latest")];
                    case 2:
                        events = _b.sent();
                        assignments = {};
