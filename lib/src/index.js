...
exports.Shield = exports.instantiateShield = exports.createShield = exports.getShields = exports.getShieldName = exports.executeCredentials = exports.decodeCredentials = exports.approveCredentials = exports.createCredentials = exports.getDefaultFactory = void 0;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        signers = _b.sent();
                        _a = (credentials.to in this.abis) ? (0, utils_1.decodeCallData)(credentials.call, this.abis[credentials.to]) : { func: sig, args: [credentials.call.slice(10)] }, func = _a.func, args = _a.args;
                        return [2 /*return*/, {
