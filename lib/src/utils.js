...
exports.parseEvents = exports.getBytesFromRoles = exports.getRolesFromBytes = exports.extractArguments = void 0;
var ethers_1 = require("ethers");
function extractArguments(iface, fragment, args) {
    var types = iface.getFunction(fragment).inputs.map(function (input) {
        return input.type;
    });
    types = types.slice(0, -1);
    return ethers_1.utils.defaultAbiCoder.decode(types, args);
}
