...
var MemoryStore = /** @class */ (function () {
    ...
    MemoryStore.setServer = function (server) { };
    ...
    MemoryStore.prototype.getInterface = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MemoryStore.interfaces[address]];
            });
        });
    };
    ...
    MemoryStore.prototype.getCredentials = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Object.values(MemoryStore.credentials)];
            });
        });
    };
...
var ServerStore = /** @class */ (function () {
    ...
    ServerStore.prototype.addInterface = function (address, iface) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.put("".concat(this.url, "/interfaces/").concat(address, "/"), {
                ...
                switch (_a.label) {
                    case 0:
                        if (address in this.cache) {
                            return [2 /*return*/, this.cache[address]];
                        }
                        return [4 /*yield*/, axios_1.default.get("".concat(this.url, "/interfaces/").concat(address, "/"))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new ethers_1.ethers.utils.Interface(response.data.interface)];
                }
            });
        });
    };
    ServerStore.prototype.addCredentials = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post("".concat(this.url, "/credentials/"), {
    ...
    ServerStore.prototype.getCredentials = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get("".concat(this.url, "/credentials/"))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data.map(function (credentials) {
