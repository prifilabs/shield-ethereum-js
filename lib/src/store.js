...
var MemoryStore = /** @class */ (function () {
    ...
    MemoryStore.prototype.addShieldable = function (address, iface) {
    ...
    MemoryStore.prototype.getShieldables = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Object.keys(MemoryStore.shields[this.key].shieldables)];
            });
        });
    };
    MemoryStore.prototype.getInterface = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, MemoryStore.shields[this.key].shieldables[address]];
            });
        });
    };
    MemoryStore.prototype.addCredentials = function (credentials) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                MemoryStore.shields[this.key].credentials[credentials.approvals[0]] = credentials;
                return [2 /*return*/];
            });
        });
    };
    ...
    MemoryStore.prototype.addTransaction = function (credentials, hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                MemoryStore.shields[this.key].transactions[credentials.approvals[0]] = hash;
                return [2 /*return*/];
            });
        });
    };
...
var ServerStore = /** @class */ (function () {
    ...
    ServerStore.prototype.addShieldable = function (address, iface) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, cross_fetch_1.default)("".concat(this.url, "/shieldables/").concat(address, "/"), {
                            method: 'PUT',
    ...
    ServerStore.prototype.getShieldables = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, cross_fetch_1.default)("".concat(this.url, "/shieldables/"))];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, cross_fetch_1.default)("".concat(this.url, "/shieldables/").concat(address, "/"))];
                    case 1:
                        response = _a.sent();
