            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, cross_fetch_1.default)("".concat(this.url, "/interfaces/").concat(address, "/"), {
                            ...
                            body: JSON.stringify({ interface: iface.format(ethers_1.ethers.utils.FormatTypes.full) }),
                        })];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        return [2 /*return*/, new ethers_1.ethers.utils.Interface(data.interface)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, cross_fetch_1.default)("".concat(this.url, "/credentials/"), {
                            method: "POST",
                            headers: { "Content-Type": "application/json", },
                            body: JSON.stringify({ credentials: Utils.encodeCredentials(credentials) }),
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
